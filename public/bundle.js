	...
	var App = React.createClass({displayName: "App",
		...
		render: function() {
			...
			var MyComponentsArray = Object.keys(MyComponents).map(function(item, index){
				...
				return React.createElement(Component, {key: item})
			})
			return (
				React.createElement("div", null, 
					React.createElement("h1", null, 
						"Hello, world!", 
						MyComponentsArray, 
						React.createElement("button", {onClick: this.handleLogin}, "Login with Github!")
					)		
				)
			);
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AnotherComponent = __webpack_require__(6);
	var ExtraComponent = __webpack_require__(7);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MyComponent = React.createClass({displayName: "MyComponent",
		...
		render: function() {
			return (
				React.createElement("div", null, 
					React.createElement("h3", null, "My Component"), 
					React.createElement("form", {onChange: this.handleChange, onSubmit: this.handleSubmit, ref: "formValue"}, 
						React.createElement("input", {type: "checkbox", value: "HAHA!"}, "Test Laugh"), 
						React.createElement("input", {type: "checkbox", value: "pizza"}, "Test Food"), 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AnotherComponent = React.createClass({displayName: "AnotherComponent",
		...
		render: function() {
			return (
				React.createElement("div", null, 
					React.createElement("h5", null, "This is another Component?")
				)
			);
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ExtraComponent = React.createClass({displayName: "ExtraComponent",

		render: function() {
			return (
				React.createElement("div", null, 
					React.createElement("h2", null, "I'm extra!")
				)
			);
		}
